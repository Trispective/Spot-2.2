...
public class Popover: UIView {
  ...
  public func show(contentView: UIView, fromView: UIView) {
    self.show(contentView: contentView, fromView: fromView, inView: UIApplication.shared.keyWindow!)
  }
  ...
  public func show(contentView: UIView, fromView: UIView, inView: UIView) {
    ...
    self.show(contentView: contentView, point: point, inView: inView)
  }

  public func show(contentView: UIView, point: CGPoint) {
    self.show(contentView: contentView, point: point, inView: UIApplication.shared.keyWindow!)
  }
